                    ...
                    Row(
                      children: [
                        CircularPercentIndicator(
                          ...
                          lineWidth: 4.0,
                          percent: 0.45,
                          center: const Text("45%", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
                        ...
                        const Column(
                          children: [
                            ...
                            Text('Task', style: TextStyle(color: Color(0xFF8E92BC), fontSize: 16),)
                          ],
                        )
                      ],
                    )
